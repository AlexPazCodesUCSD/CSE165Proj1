...
public class MouseController_tel : MonoBehaviour
{
...
/*            if (isHeld == true)
    ...
    {
        if (!leftTriggerPressed && !teleportIsHeld)
        {
            SwitchMode();
        }
    ...
    void LeftGripPress()
    {
        switch (currentMode)
        {
            ...
            case CONTROLLER_MODE.SPAWN:
                ...
                break;
            case CONTROLLER_MODE.TELEPORT:
                /* (teleportIsHeld && !leftGripPressed){
                    teleportRotation += Quaternion.Euler(new Vector3(0, 90, 0));
                    teleportIndicator.transform.rotation = teleportRotation;
                }*/
                break;
        }
