...
public class Spawner : MonoBehaviour
{
    ...
    public GameObject SpawnObject(){
        ...
        switch(furniture){  // Check which type of furniture was passed down
            case 0: //If it's the first type
                ...
                toSpawn = Instantiate(object1, offset.position, Quaternion.identity);
                break;
            case 1: // If it's the second type
                // Do the same, but create an instance of the second furniture type instead.
                toSpawn = Instantiate(object2, offset.position, Quaternion.identity);
                break;
        }
    ...
    public void SwitchFurniture(int furniture){  // Switch which type of furniture we'll spawn
        print("Switched: " + furniture);
